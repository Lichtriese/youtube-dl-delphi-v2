...
uses
  ...
  FMX.TabControl, FMX.Menus, FMX.Types, FMX.Controls;
...
begin
  ...
  try
    ...
    begin
      ...
      Memo1.Lines.Add(Format('   Quality: %s', [FYouTubeClient.Streams.Items[i].Quality]));
      Memo1.Lines.Add(Format('   QualityLabel: %s', [FYouTubeClient.Streams.Items[i].QualityLabel]));
    end;
